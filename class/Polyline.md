...
link：http://fabricjs.com/docs/fabric.Polyline.html

## 成员

### ATTRIBUTE_NAMES
    静态方法
    解析SVG元素时要考虑的属性名称列表（由fabric.Polyline.fromElement使用）
返回：``
