# fabric.Image.filters.HueRotation
色相旋转滤镜
...
### isNeutralState(options)
    ...
    HueRotation isNeutralState实现仅在图像applyFilters中使用，以丢弃不会对图像产生影响的滤镜
